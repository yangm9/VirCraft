...
def generate_amgs_table(dm_vb_merged_annot):
    rename_columns_dict = {
        'common_protein_id': 'gene_id', 'protein_id': 'dram_protein_id', 'scaffold_x': 'dram_scaffold', 'gene_position': 'gene_position',
        'start_position': 'start', 'end_position': 'end', 'strandedness': 'strand', 'rank': 'dram_rank', 'protein': 'vibrant_protein_id',
        'scaffold_y': 'vibrant_scaffold', 'KO name': 'KO_name', 'KO evalue': 'KO_evalue', 'KO score': 'KO_score','KO v-score': 'KO_v-score', 
        'Pfam name': 'Pfam_name', 'Pfam evalue': 'Pfam_evalue', 'Pfam score': 'Pfam_score','Pfam v-score': 'Pfam_v-score', 
        'VOG name': 'VOG_name', 'VOG evalue': 'VOG_evalue', 'VOG score': 'VOG_score', 'VOG v-score': 'VOG_v-score'
    }
    ...
    filt_merged_annot = f'{wkdir}/all_filted_merged_amg.tsv'
